...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function ChatPanel({ sessions, workspaces, modelDirectories, notePath, noteContent }) {
    ...
    function Workbench({ onClose, sessions, workspaces, modelDirectories }) {
      ...
      return React.createElement("div", {
        ...
        React.createElement(ChatPanel, { sessions, workspaces, modelDirectories, notePath: note?.path, noteContent: note?.image ? null : editor }),
