...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      "._ow_undobar{display:flex;align-items:center;gap:7px;margin:0 4px 7px;padding:6px 8px;border:1px solid color-mix(in srgb,#c48a25 30%,var(--dsw-alias-border-l2));border-radius:8px;background:color-mix(in srgb,#c48a25 8%,var(--dsw-alias-bg-base));color:var(--dsw-alias-label-secondary);font-size:11px}",
      "._ow_undobar span{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      "._ow_undobutton{border:0;background:transparent;color:#c48a25;font-size:11px;cursor:pointer;padding:2px 3px;white-space:nowrap}",
      "._ow_undobutton:hover{text-decoration:underline}",
      ...
      "._ow_titlebutton{border:0;background:transparent;color:inherit;padding:0;text-align:left;cursor:text;font:inherit}",
      "._ow_titlebutton:hover{text-decoration:underline;text-decoration-color:color-mix(in srgb,#7c65d7 60%,transparent);text-underline-offset:3px}",
      "._ow_titleinput{box-sizing:border-box;min-width:0;flex:1;height:32px;border:0;border-bottom:1px solid #7c65d7;border-radius:0;background:transparent;color:var(--dsw-alias-label-primary);outline:0;padding:0;font:600 14px var(--ds-font-family,Inter,system-ui,sans-serif)}",
      ...
      "._ow_cm{box-sizing:border-box;min-height:100%;max-width:1000px;margin:0 auto;padding:34px 48px 70px;font-size:15px;line-height:1.8;color:var(--dsw-alias-label-primary)}",
      "._ow_cm .cm-editor{min-height:100%;outline:0;background:transparent}",
      "._ow_cm .cm-scroller{overflow:visible;font-family:var(--ds-font-family,Inter,system-ui,sans-serif);line-height:1.8}",
      "._ow_cm .cm-content{min-height:calc(100vh - 150px);padding:0;caret-color:var(--dsw-alias-label-primary)}",
      "._ow_cm .cm-line{padding:0;margin:0 0 14px;white-space:pre-wrap;word-break:break-word}",
      "._ow_cm .cm-line._ow_cm_h1{font-size:28px;font-weight:700;line-height:1.3;margin-bottom:18px}",
      "._ow_cm .cm-line._ow_cm_h2{font-size:22px;font-weight:700;line-height:1.3;margin-top:28px;margin-bottom:18px}",
      "._ow_cm .cm-line._ow_cm_h3{font-size:18px;font-weight:700;line-height:1.3;margin-top:24px;margin-bottom:18px}",
      "._ow_cm ._ow_cm_bold{font-weight:700}",
      "._ow_cm ._ow_cm_link{color:#7c65d7;background:color-mix(in srgb,#7c65d7 12%,transparent);border-radius:4px;padding:1px 3px}",
      "._ow_cm ._ow_cm_hidden{display:none}",
      "._ow_cm[data-title-mode=true] .cm-line{font-size:28px;font-weight:700;line-height:1.3}",
      "._ow_cm[data-title-mode=true] .cm-line:empty::before{content:'输入主题…';color:var(--dsw-alias-label-tertiary)}",
      ...
      "._ow_chatmenuwrap{position:relative;flex:none}",
      "._ow_chatmenubutton{display:inline-flex;align-items:center;gap:5px;max-width:190px;height:32px;border:1px solid transparent;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary);padding:0 7px;font:11px var(--ds-font-family,Inter,system-ui,sans-serif);cursor:pointer}",
      "._ow_chatmenubutton:hover,._ow_chatmenubutton[data-open=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}",
      "._ow_chatmenubutton span:first-child{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      "._ow_chatmenu{position:absolute;right:0;top:39px;z-index:2200;width:min(310px,calc(100vw - 28px));max-height:min(520px,calc(100vh - 90px));overflow:auto;box-sizing:border-box;padding:7px;border:1px solid var(--dsw-alias-border-l2);border-radius:12px;background:var(--dsw-alias-bg-base);box-shadow:0 14px 34px rgba(36,30,18,.2)}",
      "._ow_chatmenutitle{padding:6px 9px 5px;color:var(--dsw-alias-label-tertiary);font-size:10px}",
      "._ow_chatmenuitem{display:flex;align-items:center;gap:8px;width:100%;box-sizing:border-box;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-primary);padding:8px 9px;text-align:left;cursor:pointer}",
      "._ow_chatmenuitem:hover,._ow_chatmenuitem[data-current=true]{background:color-mix(in srgb,#7c65d7 12%,var(--dsw-alias-interactive-bg-hover))}",
      "._ow_chatmenuitem strong,._ow_chatmenuitem span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      "._ow_chatmenuitem strong{font-size:12px;font-weight:500;flex:1}",
      "._ow_chatmenuitem span{color:var(--dsw-alias-label-tertiary);font-size:10px}",
      "._ow_chatmenuitem[data-new=true] strong{color:#7c65d7}",
      "._ow_chatmenusep{height:1px;margin:6px 3px;background:var(--dsw-alias-border-l1)}",
      ...
      "._ow_chatnode{min-width:0;display:flex;flex-direction:column;gap:7px}",
      ...
      "._ow_userbubble{align-self:flex-end;max-width:92%;background:#7c65d7;color:white;border-radius:11px 11px 4px 11px;padding:9px 11px;font-size:12px;line-height:1.65;white-space:pre-wrap;word-break:break-word}",
      "._ow_markdown{align-self:stretch;color:var(--dsw-alias-label-primary);font-size:13px;line-height:1.7;word-break:break-word}",
      "._ow_markdown p,._ow_markdown h1,._ow_markdown h2,._ow_markdown h3{margin:0 0 9px}",
      "._ow_markdown h1{font-size:20px;line-height:1.35}._ow_markdown h2{font-size:17px;line-height:1.4}._ow_markdown h3{font-size:15px;line-height:1.45}",
      "._ow_markdown ._ow_mdblank{height:6px}._ow_markdown ._ow_mdlist{margin:0 0 5px;padding-left:16px;white-space:pre-wrap}",
      "._ow_markdown code{border-radius:4px;background:var(--dsw-alias-markdown-code-block);padding:1px 4px;font:12px var(--ds-font-family-code,Consolas,monospace)}",
      "._ow_assistanttext{min-width:0;display:flex;flex-direction:column;gap:3px}",
      "._ow_assistantactions{display:flex;align-items:center;min-height:26px;margin-top:1px}",
      "._ow_copybutton{display:inline-flex;align-items:center;gap:5px;border:0;border-radius:6px;background:transparent;color:var(--dsw-alias-label-tertiary);padding:4px 6px;cursor:pointer;font:11px var(--ds-font-family,Inter,system-ui,sans-serif)}",
      "._ow_copybutton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._ow_copybutton:focus-visible{outline:2px solid color-mix(in srgb,#7c65d7 48%,transparent);outline-offset:1px}",
      "._ow_copyicon{width:16px;height:16px;display:block;flex:none}",
      "._ow_contextrow,._ow_thinkrow,._ow_toolrow{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:1.6}",
      "._ow_contexttoggle,._ow_thinktoggle,._ow_tooltoggle{width:100%;display:flex;align-items:center;gap:7px;min-width:0;border:0;background:transparent;color:var(--dsw-alias-label-tertiary);padding:2px 0;text-align:left;cursor:pointer;font:inherit}",
      "._ow_contexttoggle:hover,._ow_thinktoggle:hover,._ow_tooltoggle:hover{color:var(--dsw-alias-label-primary)}",
      "._ow_disclosurechevron{width:14px;flex:none;color:var(--dsw-alias-label-secondary);font-size:12px;text-align:center}",
      "._ow_disclosuretitle{flex:none;color:var(--dsw-alias-label-secondary)}",
      "._ow_disclosuresep{width:2px;height:2px;border-radius:50%;background:var(--dsw-alias-label-caption);flex:none}",
      "._ow_disclosuresummary{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex:1}",
      "._ow_contextbody{box-sizing:border-box;width:calc(100% - 21px);max-height:150px;overflow:auto;margin:3px 0 3px 21px;padding:9px 11px;border-radius:8px;background:var(--dsw-alias-markdown-code-block);font:11px/1.55 var(--ds-font-family-code,Consolas,monospace);white-space:pre-wrap;word-break:break-word}",
      "._ow_thinkbody{width:calc(100% - 21px);max-height:220px;overflow:auto;margin:3px 0 3px 21px;padding:3px 0;color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;word-break:break-word}",
      "._ow_toolbody{width:calc(100% - 21px);max-height:180px;overflow:auto;margin:3px 0 3px 21px;padding:8px 10px;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;word-break:break-word}",
      "._ow_thinkrow[data-running=true] ._ow_disclosuresummary{background:linear-gradient(90deg,#7c65d7,#b6a1f3,#7c65d7);background-size:220% 100%;color:transparent;background-clip:text;animation:_ow_think-sweep 1.8s linear infinite}@keyframes _ow_think-sweep{to{background-position:-220% 0}}",
      "._ow_contextrow + ._ow_userbubble{margin-top:1px}",
      ...
      "._ow_attachments{display:flex;flex-wrap:wrap;gap:6px;margin:-2px 0 9px}",
      "._ow_attachment{min-width:0;max-width:100%;display:flex;align-items:center;gap:7px;padding:5px 7px;border:1px solid var(--dsw-alias-border-l2);border-radius:7px;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}",
      "._ow_attachmenticon{width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;border-radius:4px;background:color-mix(in srgb,#7c65d7 14%,transparent);color:#7c65d7;font-size:11px;flex:none}",
      "._ow_attachmentbody{min-width:0;display:flex;flex-direction:column;gap:1px}",
      "._ow_attachmentname{max-width:210px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-primary);font-size:11px}",
      "._ow_attachmentmeta{max-width:210px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:9px}",
      "._ow_attachmentremove{width:20px;height:20px;border:0;border-radius:5px;background:transparent;color:var(--dsw-alias-label-tertiary);cursor:pointer;font-size:14px;line-height:1;flex:none}",
      "._ow_attachmentremove:hover{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}",
      ...
      "@media(max-width:960px){._ow_overlay{grid-template-columns:220px 1px minmax(280px,1fr)}._ow_resize[data-side=right],._ow_right{display:none}._ow_cm{padding-left:24px;padding-right:24px}}",
    ...
    const OBSIDIAN_CONTEXT_START = "<!-- DSH_OBSIDIAN_CONTEXT_START -->";
    const OBSIDIAN_CONTEXT_END = "<!-- DSH_OBSIDIAN_CONTEXT_END -->";

    function escapePromptAttribute(value) {
      return String(value || "").replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
    }

    function unescapePromptAttribute(value) {
      return String(value || "").replace(/&quot;/g, '"').replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;/g, "&");
    }

    function buildObsidianPrompt(entries, question) {
      const validEntries = entries.filter((entry) => entry?.path && typeof entry.content === "string");
      if (validEntries.length === 0) return question;
      const files = validEntries.map((entry) => `<dsh-obsidian-file path="${escapePromptAttribute(entry.path)}" name="${escapePromptAttribute(entry.name || entry.path)}">\n${entry.content}\n</dsh-obsidian-file>`).join("\n\n");
      return `${OBSIDIAN_CONTEXT_START}\n<dsh-obsidian-context>\n${files}\n</dsh-obsidian-context>\n${OBSIDIAN_CONTEXT_END}\n\n${question}`;
    }

    function parseObsidianPrompt(content) {
      const text = contentText(content);
      const start = text.indexOf(OBSIDIAN_CONTEXT_START);
      const end = start === -1 ? -1 : text.indexOf(OBSIDIAN_CONTEXT_END, start + OBSIDIAN_CONTEXT_START.length);
      if (start === -1 || end === -1) return { question: text.trim(), contexts: [] };
      const body = text.slice(start + OBSIDIAN_CONTEXT_START.length, end);
      const contexts = [];
      const filePattern = /<dsh-obsidian-file\s+path="([^"]*)"\s+name="([^"]*)">\n?([\s\S]*?)\n?<\/dsh-obsidian-file>/g;
      let match;
      while ((match = filePattern.exec(body))) {
        contexts.push({
          path: unescapePromptAttribute(match[1]),
          name: unescapePromptAttribute(match[2]),
          content: match[3]
        });
      }
      return { question: text.slice(end + OBSIDIAN_CONTEXT_END.length).trim(), contexts };
    }
    ...
    function useWorkspaceList(workspaces) {
      const [snapshot, setSnapshot] = useState(() => workspaces?.list?.getSnapshot?.() || null);
      useEffect(() => {
    ...
    function sessionRows(listSnapshot) {
      if (Array.isArray(listSnapshot?.items)) return listSnapshot.items;
      const ids = Array.isArray(listSnapshot?.ids) ? listSnapshot.ids : Object.keys(listSnapshot?.byId || {});
      return ids.map((id) => listSnapshot?.byId?.[id]).filter(Boolean);
    }

    function sessionTitle(item) {
      return item?.displayTitle || item?.title || item?.name || item?.id || item?.sessionId || "未命名对话";
    }

    function workspaceForSession(workspaceSnapshot, sessionId) {
      return (workspaceSnapshot?.items || []).find((workspace) => (workspace.sessionIds || []).includes(sessionId));
    }

    function SessionPicker({ sessions, workspaces, currentId, listSnapshot, onError }) {
      const [open, setOpen] = useState(false);
      const workspaceSnapshot = useWorkspaceList(workspaces);
      const menuRef = useRef(null);
      const currentItem = sessionRows(listSnapshot).find((item) => (item?.sessionId || item?.id) === currentId);
      const currentTitle = currentItem ? sessionTitle(currentItem) : "选择 DSH 会话";
      ...
      const startSession = (workspaceId) => {
        ...
        try {
          ...
          const created = sessions?.create?.(workspaceId ? { workspaceId } : undefined);
          Promise.resolve(created).then((id) => id && sessions?.open?.(id)).catch((error) => onError?.(error));
        } catch (error) {
          onError?.(error);
        }
      };

      const rows = sessionRows(listSnapshot).filter((item) => !(item?.blank && !item?.title && !item?.displayTitle));
      const workspacesList = workspaceSnapshot?.items || [];
      return React.createElement("div", { className: "_ow_chatmenuwrap", ref: menuRef },
        React.createElement("button", {
          className: "_ow_chatmenubutton",
          type: "button",
          "data-open": open,
          title: "选择 DSH 工作区或对话",
          onClick: () => setOpen((value) => !value)
        },
          React.createElement("span", null, currentTitle),
          React.createElement("span", { "aria-hidden": true }, "⌄")),
        open && React.createElement("div", { className: "_ow_chatmenu" },
          React.createElement("button", { className: "_ow_chatmenuitem", "data-new": true, type: "button", onClick: () => startSession() },
            React.createElement("strong", null, "＋ 新建对话"),
            React.createElement("span", null, "当前工作区")),
          workspacesList.length > 0 && React.createElement("div", { className: "_ow_chatmenusep" }),
          workspacesList.length > 0 && React.createElement("div", { className: "_ow_chatmenutitle" }, "工作区"),
          workspacesList.map((workspace) => React.createElement("button", { className: "_ow_chatmenuitem", type: "button", key: workspace.workspaceId, onClick: () => startSession(workspace.workspaceId) },
            React.createElement("strong", null, `＋ ${workspace.title || workspace.path}`),
            React.createElement("span", null, `${(workspace.sessionIds || []).length} 个对话`))),
          rows.length > 0 && React.createElement("div", { className: "_ow_chatmenusep" }),
          rows.length > 0 && React.createElement("div", { className: "_ow_chatmenutitle" }, "最近对话"),
          rows.map((item) => {
            const id = item?.sessionId || item?.id;
            const workspace = workspaceForSession(workspaceSnapshot, id);
            return React.createElement("button", { className: "_ow_chatmenuitem", "data-current": id === currentId, type: "button", key: id, onClick: () => openSession(id) },
              React.createElement("strong", null, sessionTitle(item)),
              React.createElement("span", null, workspace?.title || item?.cwd || ""));
          })));
    }
    ...
    class HiddenMarkdownToken extends WidgetType {
      toDOM() {
        const node = document.createElement("span");
        node.className = "_ow_cm_hidden";
        return node;
      }
      ignoreEvent() { return true; }
    }

    const hiddenMarkdownToken = Decoration.replace({ widget: new HiddenMarkdownToken() });
    const headingLineDecorations = [null, "_ow_cm_h1", "_ow_cm_h2", "_ow_cm_h3", "_ow_cm_h3", "_ow_cm_h3", "_ow_cm_h3"];
    ...
    function livePreviewDecorations(view) {
      ...
      const ranges = [];
      const add = (from, to, decoration, priority = 0) => {
      ...
      for (let number = 1; number <= view.state.doc.lines; number += 1) {
        ...
        if (heading) {
          ...
          add(line.from, line.from, Decoration.line({ attributes: { class: headingLineDecorations[level] } }), -10);
          if (!active) add(line.from, line.from + heading[1].length + heading[2].length, hiddenMarkdownToken, 0);
        }

        const boldPattern = /##([^#\n]+)##/g;
        let boldMatch;
        while ((boldMatch = boldPattern.exec(text))) {
          const start = line.from + boldMatch.index;
          const contentStart = start + 2;
          const contentEnd = contentStart + boldMatch[1].length;
          if (!active) add(start, contentStart, hiddenMarkdownToken, 1);
          add(contentStart, contentEnd, Decoration.mark({ class: "_ow_cm_bold" }), 2);
          if (!active) add(contentEnd, contentEnd + 2, hiddenMarkdownToken, 3);
        }

        const linkPattern = /\[\[[^\]]+\]\]/g;
        let linkMatch;
        while ((linkMatch = linkPattern.exec(text))) {
          add(line.from + linkMatch.index, line.from + linkMatch.index + linkMatch[0].length, Decoration.mark({ class: "_ow_cm_link" }), 4);
        }
      }

      ranges.sort((a, b) => a.from - b.from || a.priority - b.priority || a.to - b.to);
      const builder = new RangeSetBuilder();
      for (const item of ranges) builder.add(item.from, item.to, item.decoration);
    ...
    const livePreviewPlugin = ViewPlugin.fromClass(class {
      ...
      update(update) {
        if (update.docChanged || update.selectionSet || update.viewportChanged) this.decorations = livePreviewDecorations(update.view);
      }
    }, { decorations: (value) => value.decorations });

    function LiveMarkdownEditor({ markdown: source, onChange }) {
      const hostRef = useRef(null);
      const viewRef = useRef(null);
      const onChangeRef = useRef(onChange);
      const titleModeRef = useRef(!String(source || "").trim());
      const [titleMode, setTitleMode] = useState(titleModeRef.current);

      useEffect(() => { onChangeRef.current = onChange; }, [onChange]);

      useEffect(() => {
        if (!hostRef.current) return undefined;
        const initial = String(source || "");
        const ensureTitleLine = (view) => {
          if (!titleModeRef.current || view.state.doc.length > 0) return;
          view.dispatch({ changes: { from: 0, insert: "# " }, selection: { anchor: 2 } });
        };
        const updateListener = EditorView.updateListener.of((update) => {
          if (!update.docChanged) return;
          const value = update.state.doc.toString();
          const placeholder = titleModeRef.current && (value === "" || value === "# ");
          setTitleMode(placeholder);
        ...
        const view = new EditorView({
          state: EditorState.create({
            ...
            extensions: [
              ...
              livePreviewPlugin,
              updateListener,
              EditorView.domEventHandlers({ focus: ensureTitleLine }),
              EditorView.theme({
                "&.cm-focused": { outline: "none" },
                ".cm-selectionBackground, ::selection": { backgroundColor: "color-mix(in srgb, #7c65d7 18%, transparent)" }
              })
            ]
          }),
      ...
      useEffect(() => {
        ...
        titleModeRef.current = !next.trim();
        setTitleMode(titleModeRef.current);
        view.dispatch({ changes: { from: 0, to: view.state.doc.length, insert: next } });
      }, [source]);

      return React.createElement("div", { className: "_ow_cm", ref: hostRef, "data-title-mode": titleMode ? "true" : "false" });
    }
    ...
    function ChatMarkdown({ text }) {
      ...
      return React.createElement("div", { className: "_ow_markdown" }, lines.map((line, index) => {
        const heading = line.match(/^\s*(#{1,3})\s+(.+)$/);
        if (!line.trim()) return React.createElement("div", { className: "_ow_mdblank", key: `blank-${index}` });
        if (heading) {
          const Tag = heading[1].length === 1 ? "h1" : heading[1].length === 2 ? "h2" : "h3";
          return React.createElement(Tag, { key: `heading-${index}` }, renderInlineMarkdown(heading[2], `heading-${index}`));
        }
        const unordered = line.match(/^\s*[-*+]\s+(.+)$/);
        if (unordered) return React.createElement("div", { className: "_ow_mdlist", key: `ul-${index}` }, ["• ", ...renderInlineMarkdown(unordered[1], `ul-${index}`)]);
        const ordered = line.match(/^\s*(\d+)[.)]\s+(.+)$/);
        if (ordered) return React.createElement("div", { className: "_ow_mdlist", key: `ol-${index}` }, [`${ordered[1]}. `, ...renderInlineMarkdown(ordered[2], `ol-${index}`)]);
        return React.createElement("p", { key: `paragraph-${index}` }, renderInlineMarkdown(line, `paragraph-${index}`));
      }));
    }
    ...
    function CopyButton({ text }) {
      ...
      return React.createElement("div", { className: "_ow_assistantactions" },
        React.createElement("button", {
          className: "_ow_copybutton",
          type: "button",
          title: copied ? "已复制" : "复制本次回答",
          "aria-label": copied ? "已复制" : "复制本次回答",
          onClick: copy
        },
          React.createElement("svg", { className: "_ow_copyicon", viewBox: "0 0 24 24", fill: "none", "aria-hidden": true },
            React.createElement("rect", { x: "8", y: "8", width: "12", height: "12", rx: "2", stroke: "currentColor", "strokeWidth": "1.8" }),
            React.createElement("path", { d: "M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2", stroke: "currentColor", "strokeWidth": "1.8", "strokeLinecap": "round" })),
          copied ? "已复制" : "复制"));
    }

    function AssistantReply({ text }) {
      return React.createElement("div", { className: "_ow_assistanttext" },
        React.createElement(ChatMarkdown, { text }),
        React.createElement(CopyButton, { text }));
    }

    function ChatDisclosure({ className, title, summary, body, running = false }) {
      const [open, setOpen] = useState(false);
      return React.createElement("div", { className, "data-running": running },
        React.createElement("button", {
          className: className === "_ow_contextrow" ? "_ow_contexttoggle" : className === "_ow_thinkrow" ? "_ow_thinktoggle" : "_ow_tooltoggle",
          type: "button",
          onClick: () => setOpen((value) => !value)
        },
          React.createElement("span", { className: "_ow_disclosurechevron", "aria-hidden": true }, open ? "⌄" : "›"),
          React.createElement("span", { className: "_ow_disclosuretitle" }, title),
          summary && React.createElement("span", { className: "_ow_disclosuresep", "aria-hidden": true }),
          summary && React.createElement("span", { className: "_ow_disclosuresummary", title: summary }, summary)),
        open && body);
    }

    function ObsidianContextRow({ entry, source = "Obsidian 文件" }) {
      return React.createElement(ChatDisclosure, {
        className: "_ow_contextrow",
        title: source,
        summary: entry.name || entry.path,
        body: React.createElement("div", { className: "_ow_contextbody" }, entry.content || "")
      });
    }

    function ThinkRow({ text, running }) {
      const summary = String(text || "").trim().split("\n").filter(Boolean).slice(-1)[0] || (running ? "思考中…" : "思考");
      return React.createElement(ChatDisclosure, {
        className: "_ow_thinkrow",
        title: "Think",
        summary,
        running,
        body: React.createElement("div", { className: "_ow_thinkbody" }, text || "")
      });
    }

    function ToolRow({ title, summary, body, running = false }) {
      return React.createElement(ChatDisclosure, {
        className: "_ow_toolrow",
        title,
        summary,
        running,
        body: body ? React.createElement("div", { className: "_ow_toolbody" }, body) : null
      });
    }

    function ChatNode({ node }) {
      const data = node?.data || {};
      if (node?.kind === "user" || node?.kind === "steering") {
        const parsed = parseObsidianPrompt(data.content);
        return React.createElement("div", { className: "_ow_chatnode" },
          parsed.contexts.map((entry, index) => React.createElement(ObsidianContextRow, { entry, key: `${node.key}-context-${index}` })),
          parsed.question && React.createElement("div", { className: "_ow_userbubble" }, parsed.question));
      }
      if (node?.kind === "context") {
        const source = data.provenance?.label || data.source?.label || data.source || "上下文注入";
        const content = contentText(data.content);
        return React.createElement("div", { className: "_ow_chatnode" }, React.createElement(ObsidianContextRow, {
          entry: { name: source, path: source, content },
          source: data.provenance?.role === "recall" ? "会话回忆" : "上下文注入"
        }));
      }
      if (node?.kind === "assistant-step" || node?.kind === "assistant") {
        ...
        const lastTextIndex = blocks.reduce((last, block, index) => block?.kind === "text" ? index : last, -1);
        const renderedBlocks = blocks.length === 0 && running ? [React.createElement(ThinkRow, { key: `${node.key}-think-empty`, text: "思考中…", running: true })] : blocks.map((block, index) => {
          if (block?.kind === "reasoning") return React.createElement(ThinkRow, { key: `${node.key}-think-${index}`, text: block.text || "", running });
          if (block?.kind === "text") return index === lastTextIndex ? React.createElement(AssistantReply, { key: `${node.key}-text-${index}`, text: replyText }) : React.createElement(ChatMarkdown, { key: `${node.key}-text-${index}`, text: block.text || "" });
          if (!block) return null;
          return React.createElement(ToolRow, {
            key: `${node.key}-block-${index}`,
            title: block.kind || "附加内容",
            summary: block.name || block.type || "",
            body: block.text || JSON.stringify(block, null, 2)
          });
        });
        return React.createElement("div", { className: "_ow_chatnode" }, renderedBlocks);
      }
      if (node?.kind === "tool-call") {
        const root = data.root || data;
        return React.createElement("div", { className: "_ow_chatnode" }, React.createElement(ToolRow, {
          title: root.name || root.tool || "工具调用",
          summary: root.status || (root.result ? "已完成" : "执行中…"),
          running: !root.result && !root.error,
          body: root.result || root.error || root.input ? JSON.stringify(root.result || root.error || root.input, null, 2) : ""
        }));
      }
      if (node?.kind === "command") {
        ...
        return React.createElement("div", { className: "_ow_chatnode" }, React.createElement(ToolRow, {
          title: data.name || "命令",
          summary: outcome.text || (outcome.kind === "error" ? "执行失败" : outcome.kind ? "已完成" : "执行中…"),
          running: !outcome.kind,
          body: outcome.text || ""
        }));
      }
      if (node?.kind === "model-retry") {
        const retry = data.current || data;
        return React.createElement("div", { className: "_ow_chatnode" }, React.createElement(ToolRow, {
          title: "模型重试",
          summary: retry.message || retry.retryState || "正在重试…",
          running: retry.retryState === "scheduled"
        }));
      }
      if (node?.kind === "turn-error" || node?.kind === "unknown") {
        return React.createElement("div", { className: "_ow_error" }, data.message || data.error?.message || "会话出现错误");
      }
      return null;
    }

    function ChatPanel({ sessions, workspaces, modelDirectories, notePath, noteContent, insertRequest }) {
      ...
      const snapshotError = snapshot?.promptError?.error?.message || snapshot?.lastAgentError || "";
      useEffect(() => {
        if (!insertRequest?.id || typeof insertRequest.content !== "string") return;
        setAttachments((value) => value.some((entry) => entry.path === insertRequest.path) ? value : [...value, insertRequest]);
      }, [insertRequest?.id]);
      const send = async () => {
        ...
        setSending(true);
        setError("");
        const contextEntries = [...attachments];
        if (notePath && noteContent !== null && !contextEntries.some((entry) => entry.path === notePath)) {
          contextEntries.push({ name: notePath.split("/").pop(), path: notePath, content: noteContent.slice(0, 16000), kind: "file" });
        }
        const context = buildObsidianPrompt(contextEntries, question);
        try {
      ...
      return React.createElement("div", { className: "_ow_right" },
        React.createElement("div", { className: "_ow_chathead" },
          ...
          React.createElement(SessionPicker, { sessions, workspaces, currentId, listSnapshot, onError: (error) => setError(error?.message || String(error)) })),
        React.createElement("div", { className: "_ow_chatbody" },
          ...
          items.map((item) => React.createElement(ChatNode, { node: item, key: item.key })),
          (error || snapshotError) && React.createElement("div", { className: "_ow_error" }, error || snapshotError)),
        React.createElement("div", { className: "_ow_chatcomposer" },
          React.createElement("div", { className: "_ow_compbox" },
            attachments.length > 0 && React.createElement("div", { className: "_ow_attachments" }, attachments.map((attachment, index) => React.createElement(
              "div",
              { className: "_ow_attachment", key: `${attachment.id}-${index}` },
              React.createElement("span", { className: "_ow_attachmenticon", "aria-hidden": true }, attachment.kind === "directory" ? "□" : "▤"),
              React.createElement("div", { className: "_ow_attachmentbody" },
                React.createElement("span", { className: "_ow_attachmentname", title: attachment.name }, attachment.name),
                React.createElement("span", { className: "_ow_attachmentmeta", title: attachment.path }, attachment.kind === "directory" ? `文件夹 · ${attachment.fileCount || 0} 个文件` : "文件 · 已载入上下文")),
              React.createElement("button", { className: "_ow_attachmentremove", type: "button", title: "移除附件", "aria-label": `移除${attachment.name}`, onClick: () => setAttachments((value) => value.filter((_, itemIndex) => itemIndex !== index)) }, "×")
            ))),
    ...
    function Workbench({ onClose, sessions, workspaces, modelDirectories }) {
      ...
      const [chatInsertRequest, setChatInsertRequest] = useState(null);
      ...
      useEffect(() => {
        ...
        if (!titleEditing) setTitleValue(note.name || "");
      }, [note?.path, note?.name, note?.image, titleEditing]);
      ...
      const finishTitleEdit = async (cancel = false) => {
        if (!titleEditingRef.current) return;
        titleEditingRef.current = false;
        setTitleEditing(false);
        const currentNote = note;
        const nextName = titleValue.trim();
        if (cancel || !currentNote || currentNote.image || !nextName || nextName === currentNote.name) {
          if (!cancel && currentNote) setTitleValue(currentNote.name || "");
          return;
        }
        await renameEntry(currentNote, nextName);
      };
      ...
      const deleteEntry = async (entry) => {
        ...
        try {
          ...
          setLastDelete({ id: payload.undoId, name: entry.name });
      ...
      const undoDelete = async () => {
        if (!lastDelete?.id) return;
        setTreeActionError("");
        try {
          await requestJson(`${API}/undo-delete`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: lastDelete.id })
          });
          setLastDelete(null);
          refreshTree();
          setStatus("已撤销删除");
      ...
      const closeContextMenuOutside = (event) => {
        if (contextMenu && !event.target.closest?.("._ow_contextmenu")) setContextMenu(null);
      };
      ...
      const addToChat = async (entry) => {
        setContextMenu(null);
        if (!entry?.path) return;
        if (await saveRef.current?.() === false) return;
        try {
          setStatus(`正在整理「${entry.name}」的上下文…`);
          const payload = await requestJson(`${API}/context?path=${encodeURIComponent(entry.path)}`);
          const suffix = payload.truncated ? "（内容较多，已截取前一部分）" : "";
          setChatInsertRequest({
            id: Date.now(),
            name: entry.name,
          ...
          setStatus(`已加入对话：${entry.name}${suffix}`);
        } catch (error) {
          setTreeActionError(error.message);
      ...
      return React.createElement("div", {
        ...
        tabIndex: -1,
        onKeyDown,
        onPointerDown: closeContextMenuOutside,
        ...
        React.createElement("aside", { className: "_ow_left" },
          ...
          React.createElement("div", { className: "_ow_leftbody", onContextMenu: (event) => openContextMenu(event, null) },
            ...
            lastDelete && React.createElement("div", { className: "_ow_undobar" },
              React.createElement("span", null, `已移到回收站：${lastDelete.name}`),
              React.createElement("button", { className: "_ow_undobutton", type: "button", onClick: undoDelete }, "撤销")),
        ...
        React.createElement(ResizeHandle, { side: "left", dragging: drag?.side === "left", onPointerDown: startResize }),
          React.createElement("main", { className: "_ow_center" },
            ...
            titleEditing ? React.createElement("input", {
              className: "_ow_filename _ow_titleinput",
              ref: titleInputRef,
              value: titleValue,
              ...
              "aria-label": "修改笔记名称"
            }) : note && !note.image ? React.createElement("button", {
              className: "_ow_filename _ow_titlebutton",
              type: "button",
              onClick: beginTitleEdit,
              title: "点击修改笔记名称"
            }, note.name) : React.createElement("span", { className: "_ow_filename" }, note?.name || "选择一篇笔记")),
          React.createElement("div", { className: "_ow_editor" },
            ...
            note && !note.image && React.createElement(LiveMarkdownEditor, { markdown: editor, onChange: setEditor })),
        ...
        React.createElement(ChatPanel, { sessions, workspaces, modelDirectories, notePath: note?.path, noteContent: note?.image ? null : editor, insertRequest: chatInsertRequest }),
        contextMenu && React.createElement("div", {
          ...
          contextMenu.entry && React.createElement("button", { className: "_ow_contextitem", type: "button", onClick: () => addToChat(contextMenu.entry) }, "加入对话"),
          contextMenu.entry && React.createElement("div", { className: "_ow_contextsep" }),
        ...
        deleteDialog && React.createElement("div", { className: "_ow_dialogbackdrop", onPointerDown: () => setDeleteDialog(null) },
          React.createElement("div", { className: "_ow_dialog", onPointerDown: (event) => event.stopPropagation() },
            ...
            React.createElement("div", { className: "_ow_dialogcopy" }, deleteDialog.kind === "directory" ? "文件夹中的内容会一起移入回收站，可在删除后立即撤销。" : "文件会移入回收站，可在删除后立即撤销。"),
            React.createElement("div", { className: "_ow_dialogactions" },
    ...
    function Launcher({ sessions, workspaces, modelDirectories }) {
      const [open, setOpen] = useState(false);
      return React.createElement("div", { style: { position: "relative" } },
        ...
        open && React.createElement(Workbench, { sessions, workspaces, modelDirectories, onClose: () => setOpen(false) }));
    }

    const inject = ["slots", "sessions", "workspaces", "conversation", "modelDirectories"];
    function apply(ctx) {
      ...
      ctx.slots.inject("sidebar.footer.action", () => slots.register({
        ...
        id: "obsidian-workbench"
      }, () => React.createElement(Launcher, { sessions, workspaces, modelDirectories })));
    }
